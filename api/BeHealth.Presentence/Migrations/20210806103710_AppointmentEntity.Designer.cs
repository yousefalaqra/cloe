...
namespace BeHealth.Presentence.Migrations
{
    ...
    [Migration("20210806103710_AppointmentEntity")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BeHealth.Presentence.Entities.Appointments.AppointmentEntity", b =>
                {
                    b.Property<long>("ID")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("BeHealth.Presentence.Entities.Organization.OrganizationEntity", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1L,
                            CreatedAt = new DateTimeOffset(new DateTime(2021, 8, 6, 13, 37, 9, 927, DateTimeKind.Unspecified).AddTicks(4612), new TimeSpan(0, 3, 0, 0, 0)),
                            CreatedBy = "SYSTEM",
            ...
            modelBuilder.Entity("BeHealth.Presentence.Entities.Organization.UserEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTimeOffset(new DateTime(2021, 8, 6, 13, 37, 9, 931, DateTimeKind.Unspecified).AddTicks(8121), new TimeSpan(0, 3, 0, 0, 0)),
                            CreatedBy = "SYSTEM",
            ...
            modelBuilder.Entity("BeHealth.Presentence.Entities.Organization.WorkPlaceEntity", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1L,
                            CreatedAt = new DateTimeOffset(new DateTime(2021, 8, 6, 13, 37, 9, 931, DateTimeKind.Unspecified).AddTicks(3322), new TimeSpan(0, 3, 0, 0, 0)),
                            CreatedBy = "SYSTEM",
                            OrganizationId = 1L,
                        ...
                        {
                            ID = 2L,
                            CreatedAt = new DateTimeOffset(new DateTime(2021, 8, 6, 13, 37, 9, 931, DateTimeKind.Unspecified).AddTicks(4461), new TimeSpan(0, 3, 0, 0, 0)),
                            CreatedBy = "SYSTEM",
                            OrganizationId = 1L,
                            Title = "Biddya - Clinic"
                        });
            ...
            modelBuilder.Entity("BeHealth.Presentence.Entities.Subscription.ClientDueEntity", b =>
                {
                    b.Property<long>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.ToTable("ClientDueEntity");
                });

            modelBuilder.Entity("BeHealth.Presentence.Entities.Subscription.ClientPaymentEntity", b =>
                {
                    b.Property<long>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<DateTimeOffset>("PyamentDate")
                        .HasColumnType("datetimeoffset");
            ...
            modelBuilder.Entity("BeHealth.Presentence.Entities.Subscription.ClientsSubscriptionsEntity", b =>
                {
                    ...
                    b.Property<int>("OrgignalPeriod")
                        .HasColumnType("int");

                    b.Property<DateTimeOffset?>("PuaseTime")
                        .HasColumnType("datetimeoffset");
                    ...
                    b.ToTable("ClientsSubscriptionsEntity");
                });
            ...
            modelBuilder.Entity("BeHealth.Presentence.Entities.Appointments.AppointmentEntity", b =>
                {
                    b.HasOne("BeHealth.Presentence.Entities.Organization.ClientEntity", "ClientEntity")
                        .WithOne("Appointment")
                        .HasForeignKey("BeHealth.Presentence.Entities.Appointments.AppointmentEntity", "ClientId")
