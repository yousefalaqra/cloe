...
namespace BeHealth.Presentence.Migrations
{
    ...
    [Migration("20210804181024_ClientSubscriptions")]
    partial class ClientSubscriptions
    {
            ...
            modelBuilder.Entity("BeHealth.Presentence.Entities.Organization.OrganizationEntity", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1L,
                            CreatedAt = new DateTimeOffset(new DateTime(2021, 8, 4, 21, 10, 24, 13, DateTimeKind.Unspecified).AddTicks(2917), new TimeSpan(0, 3, 0, 0, 0)),
                            CreatedBy = "SYSTEM",
            ...
            modelBuilder.Entity("BeHealth.Presentence.Entities.Organization.UserEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTimeOffset(new DateTime(2021, 8, 4, 21, 10, 24, 20, DateTimeKind.Unspecified).AddTicks(4962), new TimeSpan(0, 3, 0, 0, 0)),
                            CreatedBy = "SYSTEM",
            ...
            modelBuilder.Entity("BeHealth.Presentence.Entities.Organization.WorkPlaceEntity", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1L,
                            CreatedAt = new DateTimeOffset(new DateTime(2021, 8, 4, 21, 10, 24, 19, DateTimeKind.Unspecified).AddTicks(4572), new TimeSpan(0, 3, 0, 0, 0)),
                            CreatedBy = "SYSTEM",
                            OrganizationId = 1L,
                        ...
                        {
                            ID = 2L,
                            CreatedAt = new DateTimeOffset(new DateTime(2021, 8, 4, 21, 10, 24, 19, DateTimeKind.Unspecified).AddTicks(6082), new TimeSpan(0, 3, 0, 0, 0)),
                            CreatedBy = "SYSTEM",
                            OrganizationId = 1L,
                            Title = "Biddya - Clinic"
                        });
