...
namespace BeHealth.Presentence.Migrations
{
    ...
    partial class BeHealthDBContextModelSnapshot : ModelSnapshot
    {
            ...
            modelBuilder.Entity("BeHealth.Presentence.Entities.Organization.OrganizationEntity", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1L,
                            CreatedAt = new DateTimeOffset(new DateTime(2021, 8, 7, 10, 20, 20, 484, DateTimeKind.Unspecified).AddTicks(1618), new TimeSpan(0, 3, 0, 0, 0)),
                            CreatedBy = "SYSTEM",
            ...
            modelBuilder.Entity("BeHealth.Presentence.Entities.Organization.UserEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTimeOffset(new DateTime(2021, 8, 7, 10, 20, 20, 490, DateTimeKind.Unspecified).AddTicks(3), new TimeSpan(0, 3, 0, 0, 0)),
                            CreatedBy = "SYSTEM",
            ...
            modelBuilder.Entity("BeHealth.Presentence.Entities.Organization.WorkPlaceEntity", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1L,
                            CreatedAt = new DateTimeOffset(new DateTime(2021, 8, 7, 10, 20, 20, 489, DateTimeKind.Unspecified).AddTicks(3761), new TimeSpan(0, 3, 0, 0, 0)),
                            CreatedBy = "SYSTEM",
                            OrganizationId = 1L,
                        ...
                        {
                            ID = 2L,
                            CreatedAt = new DateTimeOffset(new DateTime(2021, 8, 7, 10, 20, 20, 489, DateTimeKind.Unspecified).AddTicks(5079), new TimeSpan(0, 3, 0, 0, 0)),
                            CreatedBy = "SYSTEM",
                            OrganizationId = 1L,
                            Title = "Biddya - Clinic"
                        });
