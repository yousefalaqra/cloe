            ...
            modelBuilder.Entity("BeHealth.Presentence.Entities.Organization.OrganizationEntity", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1L,
                            CreatedAt = new DateTimeOffset(new DateTime(2021, 8, 5, 18, 25, 5, 445, DateTimeKind.Unspecified).AddTicks(1211), new TimeSpan(0, 3, 0, 0, 0)),
                            CreatedBy = "SYSTEM",
            ...
            modelBuilder.Entity("BeHealth.Presentence.Entities.Organization.UserEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTimeOffset(new DateTime(2021, 8, 5, 18, 25, 5, 449, DateTimeKind.Unspecified).AddTicks(1509), new TimeSpan(0, 3, 0, 0, 0)),
                            CreatedBy = "SYSTEM",
            ...
            modelBuilder.Entity("BeHealth.Presentence.Entities.Organization.WorkPlaceEntity", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1L,
                            CreatedAt = new DateTimeOffset(new DateTime(2021, 8, 5, 18, 25, 5, 448, DateTimeKind.Unspecified).AddTicks(7488), new TimeSpan(0, 3, 0, 0, 0)),
                            CreatedBy = "SYSTEM",
                            OrganizationId = 1L,
                        ...
                        {
                            ID = 2L,
                            CreatedAt = new DateTimeOffset(new DateTime(2021, 8, 5, 18, 25, 5, 448, DateTimeKind.Unspecified).AddTicks(8341), new TimeSpan(0, 3, 0, 0, 0)),
                            CreatedBy = "SYSTEM",
                            OrganizationId = 1L,
                            Title = "Biddya - Clinic"
                        });
