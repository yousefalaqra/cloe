...
namespace BeHealth.Presentence.Migrations
{
    ...
    [Migration("20210804181748_ClientSubscriptionsEdit")]
    partial class ClientSubscriptionsEdit
    {
            ...
            modelBuilder.Entity("BeHealth.Presentence.Entities.Organization.OrganizationEntity", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1L,
                            CreatedAt = new DateTimeOffset(new DateTime(2021, 8, 4, 21, 17, 47, 352, DateTimeKind.Unspecified).AddTicks(7330), new TimeSpan(0, 3, 0, 0, 0)),
                            CreatedBy = "SYSTEM",
            ...
            modelBuilder.Entity("BeHealth.Presentence.Entities.Organization.UserEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTimeOffset(new DateTime(2021, 8, 4, 21, 17, 47, 360, DateTimeKind.Unspecified).AddTicks(2271), new TimeSpan(0, 3, 0, 0, 0)),
                            CreatedBy = "SYSTEM",
            ...
            modelBuilder.Entity("BeHealth.Presentence.Entities.Organization.WorkPlaceEntity", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1L,
                            CreatedAt = new DateTimeOffset(new DateTime(2021, 8, 4, 21, 17, 47, 359, DateTimeKind.Unspecified).AddTicks(4851), new TimeSpan(0, 3, 0, 0, 0)),
                            CreatedBy = "SYSTEM",
                            OrganizationId = 1L,
                        ...
                        {
                            ID = 2L,
                            CreatedAt = new DateTimeOffset(new DateTime(2021, 8, 4, 21, 17, 47, 359, DateTimeKind.Unspecified).AddTicks(6518), new TimeSpan(0, 3, 0, 0, 0)),
                            CreatedBy = "SYSTEM",
                            OrganizationId = 1L,
                            Title = "Biddya - Clinic"
                        });
